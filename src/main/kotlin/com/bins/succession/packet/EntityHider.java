package com.bins.succession.packet;
...
public class EntityHider implements Listener {
    ...
    private static final PacketType[] ENTITY_PACKETS = {
            ...
            ENTITY_EFFECT, REMOVE_ENTITY_EFFECT, BLOCK_BREAK_ANIMATION, NAMED_SOUND_EFFECT,
            ENTITY_SOUND, CUSTOM_SOUND_EFFECT
        ...
        return new PacketAdapter(plugin, ENTITY_PACKETS) {
            ...
            public void onPacketSending(PacketEvent event) {
                ...
                if (event.getPacketType() == PacketType.Play.Server.NAMED_SOUND_EFFECT) {
                    ...
                    if(event.getPlayer() == closest){
                        return;
                    }
                    if (Succession.entityHider.canSee(event.getPlayer(), closest)) {
                        return;
                    }
                    event.setCancelled(true);
